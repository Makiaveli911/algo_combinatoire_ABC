...
//
//             file << "Fonction: " << func_name << ", Dimension: " << dim
//                  << ", Fitness Moyenne sur " << num_executions << " exécutions: " << avg_fitness << "\n";
//             file << "Fonction: " << func_name << ", Dimension: " << dim
//                  << ", Écart Type sur " << num_executions << " exécutions: " << std_fitness << "\n";
//
//             file.close();
//         }
//     }
...
//     std::cout << "Temps total d'exécution: " << elapsed_time.count() << " secondes\n";
//
//     return 0;
// }
